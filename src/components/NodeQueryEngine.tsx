        ...
        <>
            ...
            >
                <motion.div
                    ...
                    className={`shadow-md rounded-lg overflow-hidden backdrop-blur-md border transition-all duration-300 ${isFocused
                ...
                >
                    <div className="flex items-center px-3 py-2 gap-2.5">
                        ...
                        <input
                            ...
                            className={`flex-1 bg-transparent border-none outline-none font-mono text-[13px] sm:text-sm placeholder-slate-400 dark:placeholder-slate-500 ${appTheme === 'dark' ? 'text-slate-200' : 'text-slate-800'
                    ...
                    <AnimatePresence>
                        {(isFocused || hasQuery) && (
                            <motion.div
                                ...
                                className={`border-t flex items-center justify-between text-xs px-4 py-2 overflow-hidden ${appTheme === 'dark' ? 'border-slate-800 bg-[#0d1117]' : 'border-slate-200 bg-slate-50'
                                    }`}
                            >
                                ...
                                <div className="flex gap-4 items-center shrink-0">
                                    <button
                                        ...
                                        className={`text-[10px] font-bold px-2 py-0.5 rounded cursor-pointer transition-colors ${searchEngineMode === 'strict'
                ...
                <AnimatePresence>
                    {isFocused && (
                        <motion.div
                            ...
                            className={`mt-2 rounded-lg shadow-lg border overflow-hidden absolute w-full ${appTheme === 'dark' ? 'bg-[#0d1117]/95 backdrop-blur-md border-slate-800 text-slate-300' : 'bg-white/95 backdrop-blur-md border-slate-300 text-slate-700'
                                }`}
                        >
