...
import { SquareDashed, MoreHorizontal, Type, Copy, Expand, Download, Trash2, Link, MousePointer, ZoomIn, ZoomOut, Check, X, Hand, Minus, Plus, Layers, MousePointer2, Crop, Brush, Circle, Square, Triangle, Activity, Sliders, RotateCw, ChevronDown, ChevronUp, Droplets, ChevronLeft, EyeOff, Eye } from 'lucide-react';
...
import { BrushPreview } from './panels/BrushPreview';
import { ToolBtn } from './shared/ToolBtn';
import { ColorPickerTrigger } from './shared/ColorPickers';
import { formatFileSize as formatBytes } from '../../../lib/formatFileSize';
...
export interface CanvasViewportProps {
  ...
  fabricRef: any;
  setArtboardDropdown: any;
  artboardDropdown: any;
  createArtboard: any;
  ...
  zoomPercent: any;
  artboardsRef: any;
  activeArtboardIdRef: any;
  setIsResizingPanel: any;
  isResizingPanel: any;
  activeTool: any;
  setTool: any;
  addText: any;
  ...
  showMobilePanel: any;
  transformComponentRef: any;
  comparisonZoom: any;
  setComparisonZoom: any;
  originalImageUrl: any;
  showDiagnostics: any;
  comparisonPreviewMode: any;
  optimizedImageUrl: any;
  setShowDiagnostics: any;
  exportTarget: any;
  isGeneratingPreview: any;
  currentPreviewOp: any;
  showMobileDiagnosticsSheet: any;
  setShowMobileDiagnosticsSheet: any;
  setExportSettings: any;
  handleExport: any;
  setMobileDetailsExpanded: any;
  mobileDetailsExpanded: any;
  setComparisonPreviewMode: any;
  showMobileCompareSwitcher: any;
  setShowMobileCompareSwitcher: any;
  sliderRef: any;
  handlePointerMove: any;
  handlePointerUp: any;
  handleKeyDown: any;
  isDraggingDivider: any;
  originalPreviewDims: any;
  optimizedPreviewDims: any;
  comparisonDivider: any;
  handlePointerDown: any;
  setComparisonDivider: any;
}

export const CanvasViewport: React.FC<CanvasViewportProps> = ({ activeTab, isMobile, setShowMobileArtboardsGallery, artboards, activeArtboardId, setActiveArtboardId, fabricRef, setArtboardDropdown, artboardDropdown, createArtboard, setRenamingArtboard, setActiveTab, setExportTarget, deleteArtboard, importAssets, comparisonMode, canvasRef, showHud, hudPosition, brushSize, activeBrushProperty, brushOpacity, brushHardness, hudFadingOut, isLoaded, isCropping, cropSessionRef, applyCrop, cancelCrop, psnr, optimizedSize, originalSize, exportSettings, setZoomPercent, zoomPercent, artboardsRef, activeArtboardIdRef, setIsResizingPanel, isResizingPanel, activeTool, setTool, addText, enterCropMode, brushColor, changeCurrentColor, setShowMobilePanel, showMobilePanel, transformComponentRef, comparisonZoom, setComparisonZoom, originalImageUrl, showDiagnostics, comparisonPreviewMode, optimizedImageUrl, setShowDiagnostics, exportTarget, isGeneratingPreview, currentPreviewOp, showMobileDiagnosticsSheet, setShowMobileDiagnosticsSheet, setExportSettings, handleExport, setMobileDetailsExpanded, mobileDetailsExpanded, setComparisonPreviewMode, showMobileCompareSwitcher, setShowMobileCompareSwitcher, sliderRef, handlePointerMove, handlePointerUp, handleKeyDown, isDraggingDivider, originalPreviewDims, optimizedPreviewDims, comparisonDivider, handlePointerDown, setComparisonDivider }) => {
  return (
    <>
