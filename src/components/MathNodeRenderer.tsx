...
export const MathNodeRenderer: React.FC<MathNodeRendererProps> = ({
  ...
  >(null);
  const [dragEnabledFormulaId, setDragEnabledFormulaId] = useState<
    number | null
  >(null);
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {(() => {
                    ...
                    const filteredFormulas = activeFormulas.filter((f) =>
                      f.name
                        .toLowerCase()
                        .includes(formulaSearchQuery.toLowerCase()),
                    );
                    ...
                    const favoriteFormulas = filteredFormulas
                      ...
                      .sort((a, b) => {
                        const orderA =
                          (a as any).sortOrder !== undefined
                            ? (a as any).sortOrder
                            : a.id || 0;
                        const orderB =
                          (b as any).sortOrder !== undefined
                            ? (b as any).sortOrder
                            : b.id || 0;
                          ...
                          <div className="flex flex-col gap-3 animate-fadeIn">
                            ...
                            <div className="relative">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setFormulaSearchQuery(e.target.value)
                                }
                            ...
                            {savedFormulas.length === 0 ? (
                              <div className="text-[11px] text-slate-450 dark:text-slate-550 italic p-3 text-center rounded-xl bg-slate-50/50 dark:bg-slate-900/10 border border-slate-200/50 dark:border-slate-800/30 select-none">
                                ...
                                <Bookmark
                                  size={11}
                                  className="inline mx-0.5 text-slate-400"
                                />{" "}
                                ...
                                {favoriteFormulas.length > 0 && (
                                  <div className="flex flex-col gap-1.5 animate-fadeIn">
                                    <div className="text-[9px] font-semibold text-rose-500 dark:text-rose-450 tracking-wider uppercase flex items-center gap-1 mb-0.5 px-0.5 font-sans">
                                      ...
                                      />
                                      <span>
                                        Favorites ({favoriteFormulas.length})
                                      </span>
                                    </div>
                                    {favoriteFormulas.map((formula, index) => (
                                      <React.Fragment key={formula.id}>
                                        ...
                                        <div
                                          draggable={
                                            dragEnabledFormulaId === formula.id
                                          }
                                          onDragStart={(e) =>
                                            handleDragStart(
                                              e,
                                          ...
                                          onDragOver={(e) =>
                                            handleDragOver(e, index, "favorite")
                                          }
                                          ...
                                          <div className="flex items-center justify-between gap-2">
                                            <div className="flex items-center gap-1.5 min-w-0">
                                              ...
                                              >
                                                <GripVertical
                                                  size={13}
                                                  className="opacity-80 group-hover/formula:opacity-100"
                                                />
                                              </div>
                                              ...
                                              >
                                                <Heart
                                                  size={14}
                                                  className="text-[#F43F5E] fill-[#F43F5E] stroke-[2.5]"
                                                />
                                              </button>

                                              {/* Name */}
                                              <span
                                                className="font-bold text-xs text-rose-950 dark:text-rose-100 truncate"
                                                title={formula.name}
                                              >
                                                {formula.name}
                                              </span>
                                            ...
                                            <div className="flex items-center gap-1.5 flex-shrink-0">
                                              ...
                                              <button
                                                onClick={async () => {
                                                  if (formula.id) {
                                                    await db.customFormulas.delete(
                                                      formula.id,
                                                    );
                                                  }
                                                }}
                                          ...
                                          formula.id ? (
                                            <div className="pl-5 pr-1 mt-0.5">
                                              <input
                                                ...
                                                onBlur={() =>
                                                  handleSaveExpr(formula.id!)
                                                }
                                                onKeyDown={(e) => {
                                                  if (e.key === "Enter")
                                                    handleSaveExpr(formula.id!);
                                                  if (e.key === "Escape")
                                                    setEditingFormulaFieldId(
                                                      null,
                                                    );
                                                }}
                                  ...
                                  {nonFavoriteFormulas.map((formula, index) => (
                                    <React.Fragment key={formula.id}>
                                      ...
                                      <div
                                        ...
                                        onDragStart={(e) =>
                                          handleDragStart(e, index, "regular")
                                        }
                                        onDragOver={(e) =>
                                          handleDragOver(e, index, "regular")
                                        }
                                        onDragLeave={handleDragLeave}
                                        onDragEnd={handleDragEnd}
                                        ...
                                        <div className="flex items-center justify-between gap-2">
                                          <div className="flex items-center gap-1.5 min-w-0">
                                            ...
                                            >
                                              <GripVertical
                                                size={13}
                                                className="opacity-60 group-hover/formula:opacity-100 transition-opacity"
                                              />
                                            </div>
                                            ...
                                            {/* Name */}
                                            <span
                                              className="font-bold text-xs text-slate-850 dark:text-slate-100 truncate"
                                              title={formula.name}
                                            >
                                              {formula.name}
                                            </span>
                            ...
                            <div className="flex items-center justify-center gap-1.5 py-1.5 text-[10px] text-slate-400/90 dark:text-slate-500 font-sans tracking-wide select-none font-semibold text-center border-t border-slate-200/40 dark:border-slate-800/40 mt-1">
                              <Sparkles
                                size={11}
                                className="text-blue-400 animate-pulse fill-blue-400/10"
                              />
                              <span>
                                Drag to reorder • Click + to add a new formula
                              </span>
                            </div>
                          </div>
                        )}
