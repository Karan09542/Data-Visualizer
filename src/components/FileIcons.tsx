...
export const PythonIcon = ({
  ...
  // Each logo has its own gradient ids. With shared ones every logo paints from the first in the
  // page, and when that one sits in something hidden (display: none) none of them paint at all.
  const uid = React.useId().replace(/[^a-zA-Z0-9_-]/g, "");
  const top = `py-top-${uid}`;
  const bottom = `py-bottom-${uid}`;
  return (
    <svg 
      viewBox="0 0 32 32"
      width={size}
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M18.9834 30C21.1805 30 22.9616 28.2755 22.9616 26.1482V23.4815L16.0763 23.4815L16.0763 22.7408L26.0217 22.7408C28.2188 22.7408 29.9998 21.0162 29.9998 18.8889V13.1111C29.9998 10.9838 28.2188 9.25928 26.0217 9.25928L23.7266 9.25928V12.5185C23.7266 14.6459 21.9455 16.3704 19.7485 16.3704L12.4042 16.3704C10.5451 16.3704 9.03809 17.8296 9.03809 19.6296L9.03809 26.1482C9.03809 28.2755 10.8192 30 13.0162 30H18.9834ZM19.9015 25.2593C19.1409 25.2593 18.5244 25.8562 18.5244 26.5926C18.5244 27.329 19.1409 27.9259 19.9015 27.9259C20.662 27.9259 21.2785 27.329 21.2785 26.5926C21.2785 25.8562 20.662 25.2593 19.9015 25.2593Z" fill={`url(#${bottom})`}/>
    <defs>
      <linearGradient id={top} x1="12.4809" y1="2" x2="12.4809" y2="22.7407" gradientUnits="userSpaceOnUse">
        <stop stopColor="#327EBD"/>
        <stop offset="1" stopColor="#1565A7"/>
      </linearGradient>
      <linearGradient id={bottom} x1="19.519" y1="9.25928" x2="19.519" y2="30" gradientUnits="userSpaceOnUse">
