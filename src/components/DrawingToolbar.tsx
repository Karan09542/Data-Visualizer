                    ...
                    {TOOLS.map((t, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex flex-col items-center justify-center gap-1 w-[60px] h-[64px] rounded-xl transition-all shrink-0 snap-start border ${isActive
                          ...
                          {FUNCTION_PRESETS.map((preset) => {
                            ...
                            return (
                              <button
                                ...
                                className={`px-3 py-1.5 text-[11px] font-semibold rounded-lg transition-all flex items-center gap-1 border ${isSelected
                                      ...
                                      <div className="grid grid-cols-2 gap-1">
                                        {filteredItems.map((item) => (
                                          <button
                                            ...
                                            className={`px-1.5 py-1 text-[9px] text-left rounded transition-all font-mono border ${store.functionExpression === item.expr
                              ...
                              <div className="flex flex-wrap gap-1 mt-1">
                                {ARROW_TIP_PRESETS.map((preset) => (
                                  <button
                                    ...
                                    className={`px-2 py-1 text-[10px] font-semibold rounded-md transition-all border ${store.customArrowTipEquation === preset.expr
                                        ? 'bg-blue-600 text-white border-blue-500 shadow-sm'
                              ...
                              <div className="flex flex-wrap gap-1 mt-1">
                                {ARROW_LINE_PRESETS.map((preset) => (
                                  <button
                                    ...
                                    className={`px-2 py-1 text-[10px] font-semibold rounded-md transition-all border ${store.customArrowLineEquation === preset.expr
                                        ? 'bg-blue-600 text-white border-blue-500 shadow-sm'
                                        : 'bg-white dark:bg-[#0b1120] text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-700'
                                      }`}
                                  >
          ...
          {TOOLS.map(t => {
            ...
            return (
              <button
                ...
                className={`p-2 rounded-xl transition-all flex items-center justify-center ${isActive
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {ARROW_TIP_PRESETS.map((preset) => (
                      <button
                        key={preset.label}
                        onClick={() => store.setCustomArrowTipEquation(preset.expr)}
                        className={`px-1.5 py-1 text-[9px] font-semibold rounded-md transition-all border ${store.customArrowTipEquation === preset.expr
                            ? 'bg-blue-600 text-white border-blue-500 shadow-sm'
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {ARROW_LINE_PRESETS.map((preset) => (
                      <button
                        key={preset.label}
                        onClick={() => store.setCustomArrowLineEquation(preset.expr)}
                        className={`px-1.5 py-1 text-[9px] font-semibold rounded-md transition-all border ${store.customArrowLineEquation === preset.expr
                            ? 'bg-blue-600 text-white border-blue-500 shadow-sm'
                            : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border-transparent hover:bg-slate-200 dark:hover:bg-slate-700'
                          }`}
                      >
                ...
                {FUNCTION_PRESETS.map(p => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-2.5 py-1.5 rounded-md text-[10px] transition-all flex items-center gap-1.5 ${isSelected
                            ...
                            <div className="grid grid-cols-2 gap-1.5">
                              {filteredItems.map((item) => (
                                <button
                                  ...
                                  className={`px-2 py-1.5 text-[10px] text-left rounded transition-all font-mono border ${store.functionExpression === item.expr
