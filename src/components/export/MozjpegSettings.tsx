  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-xs font-black text-slate-800 dark:text-slate-200 uppercase tracking-widest">MozJPEG Architecture</span>
      </div>
      ...
      <div className="space-y-3 bg-white dark:bg-slate-900 p-3 rounded-xl border border-slate-200 dark:border-slate-700/50">
        <div className="flex justify-between items-center">
          <div className="flex flex-col">
            <label className="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest">Global Quality</label>
      ...
      {(mode === 'advanced' || mode === 'expert') && (
        <div className="space-y-3 animate-in fade-in slide-in-from-top-1 duration-300">
           <div className="grid grid-cols-2 gap-2">
            <label className="flex items-center gap-3 cursor-pointer group bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700/50 hover:border-blue-500/20 transition-all select-none">
              ...
              <span className="text-[10px] text-slate-600 dark:text-slate-400 group-hover:text-slate-800 dark:text-slate-200 transition-colors font-bold uppercase tracking-tight">Progressive</span>
            </label>
            <label className="flex items-center gap-3 cursor-pointer group bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700/50 hover:border-blue-500/20 transition-all select-none">
              <div className="relative flex items-center justify-center">
                <input
              ...
              <span className="text-[10px] text-slate-600 dark:text-slate-400 group-hover:text-slate-800 dark:text-slate-200 transition-colors font-bold uppercase tracking-tight">Baseline</span>
            </label>
          </div>

          <label className="flex items-center gap-3 cursor-pointer group bg-white dark:bg-slate-900 p-3 rounded-xl border border-slate-200 dark:border-slate-700/50 hover:border-blue-500/20 transition-all select-none">
            <div className="relative flex items-center justify-center">
              <input
                type="checkbox"
            ...
            <div className="flex flex-col">
              <span className="text-[10px] text-slate-600 dark:text-slate-400 group-hover:text-slate-800 dark:text-slate-200 transition-colors font-bold uppercase tracking-tight">Arithmetic Coding</span>
              <span className="text-[9px] text-slate-600">Advanced entropy (Safari restricted)</span>
            </div>
          </label>

          <div className="space-y-2 bg-white dark:bg-slate-900 p-3 rounded-xl border border-slate-200 dark:border-slate-700/50">
            <div className="flex justify-between items-center mb-1">
              <label className="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest">Chroma Subsampling</label>
            </div>
            <select
              value={options.chroma_subsample}
              onChange={(e) => onChange({ chroma_subsample: parseInt(e.target.value) })}
              className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700/50 rounded-lg px-2 py-2 text-xs text-slate-700 dark:text-slate-300 outline-none focus:border-blue-500/50 appearance-none cursor-pointer font-bold"
            >
      ...
      {mode === 'expert' && (
        <div className="space-y-4 pt-2 border-t border-slate-200 dark:border-slate-700/50 animate-in fade-in duration-500">
          <div className="space-y-3 bg-white dark:bg-slate-900 p-3 rounded-xl border border-slate-200 dark:border-slate-700/50">
             <div className="flex justify-between items-center">
              <label className="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest">Smoothing</label>
              <span className="text-[10px] font-mono font-black text-slate-500 bg-white dark:bg-slate-800 px-1.5 rounded">{options.smoothing}</span>
            </div>
            <input
              type="range"
              min="0"
          ...
          <div className="grid grid-cols-1 gap-2">
            <label className="flex items-center gap-3 cursor-pointer group bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700/50 select-none">
              ...
              <span className="text-[10px] text-slate-600 dark:text-slate-400 font-bold uppercase tracking-tight">Optimize Huffman Tables</span>
            </label>
            ...
            <label className="flex items-center gap-3 cursor-pointer group bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700/50 select-none">
              ...
              <span className="text-[10px] text-slate-600 dark:text-slate-400 font-bold uppercase tracking-tight">Trellis Quantization</span>
            </label>
            ...
            <label className="flex items-center gap-3 cursor-pointer group bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700/50 select-none">
              ...
              <span className="text-[10px] text-slate-600 dark:text-slate-400 font-bold uppercase tracking-tight">Sync Chroma Quality</span>
            </label>
          </div>
          ...
          {options.separate_chroma_quality && (
            <div className="space-y-3 p-3 bg-[#0A0A0A] rounded-xl border border-slate-200 dark:border-slate-700/50">
              ...
              <input
                ...
                className="w-full h-1 bg-white dark:bg-slate-800 rounded-lg appearance-none cursor-pointer accent-blue-600"
              />
            </div>
          )}
