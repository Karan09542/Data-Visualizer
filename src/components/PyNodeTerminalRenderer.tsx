...
interface PyNodeTerminalRendererProps {
  path: string; // The parent path
  width?: number;
  height?: number;
}

export function PyNodeTerminalRenderer({
  path,
  width,
  height,
  ...
  return (
    <div
      ref={containerRef}
      className="flex flex-col nodrag group resize overflow-hidden rounded-md bg-white dark:bg-[#0d1117] border border-slate-200 dark:border-slate-800 shadow-lg relative pointer-evenpy-auto pb-[14px] pr-[14px]"
      style={{
        minHeight: "80px",
        minWidth: "200px",
