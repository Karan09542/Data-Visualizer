          ...
          <div className={appTheme}>
            ...
            >
              ...
              {contextMenu.node.type === "string" &&
                ...
                >
                  <Eye size={16} className="text-emerald-400 dark:text-emerald-500" />
                  {manuallyRenderedNodes && manuallyRenderedNodes[contextMenu.node.id]
                    ? "Hide Media Preview"
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (contextMenu.node.type === "string") {
                      ...
                      const isPdf = val.match(/\.pdf(\?.*)?$/i) || val.startsWith("data:application/pdf") || (val.startsWith("blob:http") && val.includes("pdf"));
